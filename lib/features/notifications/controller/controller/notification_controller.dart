...
final notificationControlleProvider = StateNotifierProvider<NotificationController,bool>((ref) {
  return NotificationController(notificationAPI: ref.watch(notificationAPIProvider));
});

final getLatestNOtificatiionProvider = StreamProvider((ref) {
...
final getNotificationsProvider = FutureProvider.family((ref,String uid) async {
  final notificationController = ref.watch(notificationControlleProvider.notifier);
...
class NotificationController extends StateNotifier<bool> {
  ...
  _notificationAPI = notificationAPI,
   ...
   Future<List<model.Notification>> getNotifications(String uid)async{
    ...
    return notifications.map((e) => model.Notification.fromMap(e.data)).toList();
   } 
